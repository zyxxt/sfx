...
<template>
    <div class="scrollbar-horizontal" @click="jump" ref="container">
        <div class="scrollbar-horizontal-inner unselectable"
             :class="scrollDown ? 'scrollbar-no-transition' : ''"
             :style="{ width: options.inner + 'px', left: options.movement + 'px', height: scrollWidth + 'px' }"
             @mousedown="onScrollDown"
             ref="scrollbar"></div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            jump (e) {
                ...
                let offset = e.pageX - (position.left + avg);
